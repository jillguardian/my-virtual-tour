...
final class ImageProperties {
    ...
    @Autowired
    public ImageProperties(@Value("${location.image.resize}") boolean autoResize,
                           @Value("${location.image.max-width}") Integer maxWidth,
                           @Value("${location.image.max-height}") Integer maxHeight,
                           @Value("${location.image.quality}") Double quality,
                           @Value("${location.image.preview.resize}") boolean previewAutoResize,
                           @Value("${location.image.preview.max-width}") Integer previewMaxWidth,
                           @Value("${location.image.preview.max-height}") Integer previewMaxHeight,
                           @Value("${location.image.preview.quality}") Double previewQuality) {
